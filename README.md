...
* [cite_start]**The Impact:** Optimized database performance by **30%** using Mongoose schema indexing and `.distinct()` aggregation[cite: 18].
...
| **Domain** | **Technologies** |
| :--- | :--- |
| **Languages** | [cite_start]`C++`, `JavaScript (ES6+)`, `TypeScript`, `Python`, `SQL` [cite: 33] |
| **Frontend** | [cite_start]`React.js`, `Next.js`, `Tailwind CSS`, `HTML` [cite: 34] |
| **Backend & Databases** | [cite_start]`Node.js`, `Express.js`, `Django`, `MongoDB`, `PostgreSQL`, `Redis` [cite: 34] |
| **Tools & Cloud** | [cite_start]`Git`, `GitHub`, `Vercel`, `AWS`, `Postman` [cite: 35] |
