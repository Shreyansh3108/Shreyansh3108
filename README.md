...
| **Frontend** | `Next.js (15/16)`, `React.js`, `Tailwind CSS`, `ShadCN UI` |
| **Backend & Databases** | `Node.js`, `Express.js`, `Django`, `MongoDB`, `PostgreSQL`, `Redis` |
| **Architecture & APIs** | `Prisma`, `Stripe`, `Clerk`, `Gemini AI`, `REST APIs`, `Socket.io` |
| **Tools & Cloud** | `Git`, `GitHub`, `AWS`, `Vercel`, `Docker`, `Postman` |
